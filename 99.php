...
<html lang="zh-cn">
  <head>
    <title>九块九白菜价商品集散地</title>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no"/>
    <meta name="keywords" content="九块九,内部优惠券,白菜价,折扣,优惠"/>
    ...
    <div class="container">
      <div class="row">
          ...
          <?php
            ...
            if (! $offset) { $offset = 1; }
            $per_page = 8;
            $total = $db->query('SELECT COUNT(*) FROM nine')->fetchColumn(0);

            $limitedSQL = 'SELECT * FROM nine  ORDER BY id DESC ' .
